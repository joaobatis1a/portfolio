...
const UNLOCKED: UnlockedProjectData[] = [
  ...
  },
  {
    ...
    shortDesc: "Plataforma que conecta jovens talentos a oportunidades profissionais reais, com um assistente de IA que identifica habilidades a partir de conversas.",
    fullDesc: "Plataforma de Oportunidades e Novos Talentos Emergentes, conecta jovens talentos a oportunidades profissionais reais, com apoio do Manguelito, um assistente de IA que identifica habilidades a partir de conversas. Conduzi os rituais ágeis como Scrum Master e dirigi toda a frente de design e desenvolvimento front-end: sistema de rotas, componentização, prototipagem no Figma e handoff para o time. O backend roda em Python, com FastAPI e MongoDB. O projeto nasceu de uma demanda real identificada durante vivências acadêmicas.",
    role: "Líder de Front-end & Scrum Master",
    stack: ["HTML", "CSS", "JavaScript", "Python", "FastAPI", "MongoDB", "Figma"],
